    ...
    <div className="container-home">
      ...
      <div id="welcome">
        <main className="home-main">
          ...
          <br />
          <button type="button" className="scan-button" onClick={() => handleScanButtonClick('QR')}>Scan QR Code</button>
          <button type="button" className="scan-button" onClick={() => handleScanButtonClick('BARCODE')}>Scan Barcode</button>
        </main>
        <br />
        ...
        <div id="output">
          ...
          {productDetail && productDetail.item && productDetail.meta_data && (
            <div className="product-details">
              ...
              <Image src={`https://dyq4yrh81omo6.cloudfront.net/items/290/${productDetail.meta_data.image.replace("items/", "")}`}
                alt={productDetail.meta_data.image_alt || productDetail.item.title} width={150} height={150} />
